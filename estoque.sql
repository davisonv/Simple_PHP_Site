...
CREATE TABLE `produtos` (
  ...
  `forn_produto` varchar(255) DEFAULT NULL,
  `nr_produto` int(11) DEFAULT NULL,
...
INSERT INTO `produtos` VALUES (2,'Mouse',2,'Periféricos','Razer',1);
...
-- Dump completed on 2019-11-28 21:04:18
